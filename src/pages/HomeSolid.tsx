...
import HomeHeroSolid from '../component/HomeHeroSolid.tsx';
...
const HomeSolid: React.FC = () => {
    return (
        <>
            {/* <!-- ====================================== Section Hero Slider ===================================== --> */}
            <section className="hero-slider-section position-relative">
                <HomeHeroSolid />
