        ...
        <>
            <Swiper {...heroSlider} className="swiper hero-slider">
                <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide main-swiper-solid-bg" id="hero-slider-img1">
                    ...
                    <SwiperSlide className="swiper-slide main-swiper-solid-bg" id="hero-slider-img2">
                        <div className="slide-content">
                            <div className="container">
                                <div className="row main-swiper-row">
                                    <div className="col-xxl-6 col-xl-6 col-lg-10 clearfix-space animate-slide">
                    ...
                    <SwiperSlide className="swiper-slide main-swiper-solid-bg video-slide">
