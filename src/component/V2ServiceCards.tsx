...
export const V2ServiceCards: React.FC<V2ServiceCardsProps> = ({
    ...
    caption = "What We Do",
    subtitle = "From emergency repairs to scheduled maintenance and specialized installations, Nyumba Dynamics delivers certified engineering across residential, commercial, and industrial properties."
}) => {
