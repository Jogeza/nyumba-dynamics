...
//
// "Projects" and "Smart Home Solutions" don't have dedicated routes yet
// (that's Phase 4/5 work) so they point at the closest existing pages for
// now: /properties and /services respectively.
