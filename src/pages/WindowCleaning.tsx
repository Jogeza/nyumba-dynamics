...
import WindowImg1 from '../assets/images/house-cleaning/window-img1.jpg';
import WindowImg2 from '../assets/images/house-cleaning/window-img2.jpg';
import WindowImg3 from '../assets/images/house-cleaning/window-img3.jpg';
import WindowImg4 from '../assets/images/house-cleaning/window-img4.jpg';
                            ...
                            <div className="swiper singleServicesSlider">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <img src={WindowImg2} alt="window-img2" />
                                    </div>
                                    <div className="swiper-slide">
                                        <img src={WindowImg3} alt="window-img3" />
                                    </div>
                                    <div className="swiper-slide">
                                        <img src={WindowImg4} alt="window-img4" />
                                    </div>
                                </div>
                            </div>
