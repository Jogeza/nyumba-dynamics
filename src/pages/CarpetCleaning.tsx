...
import CarpetImg1 from '../assets/images/house-cleaning/carpet-img1.jpg';
import CarpetImg2 from '../assets/images/house-cleaning/carpet-img2.jpg';
import CarpetImg3 from '../assets/images/house-cleaning/carpet-img3.jpg';
import CarpetImg4 from '../assets/images/house-cleaning/carpet-img4.jpg';
                            ...
                            <div className="swiper singleServicesSlider">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <img src={CarpetImg2} alt="carpet-img2" />
                                    </div>
                                    <div className="swiper-slide">
                                        <img src={CarpetImg3} alt="carpet-img3" />
                                    </div>
                                    <div className="swiper-slide">
                                        <img src={CarpetImg4} alt="carpet-img4" />
                                    </div>
                                </div>
                            </div>
